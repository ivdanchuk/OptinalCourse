...
<body>
        <div class="container">
            <form action="${context}/controller" method="get"  id="userForm" role="form" data-toggle="validator" >
				...
				<div class="form-group col-xs-3">				
                    ...
                    <label for="name" class="control-label col-xs-5">Name:</label>
        			...
        			<input type="checkbox" id="changePass" name="changePass" value="1">
  					<label for="changePass" class="control-label col-xs-5">Change password</label><br>
                    ...
                    <label for="role" class="control-label col-xs-5">Role:</label>                    
					<select class="form-control" id="role_id" name="role_id">
							<c:forEach var="role" items="${roles}">
								<c:choose>
								    <c:when test="${role.id==selectedUser.role_id}">
