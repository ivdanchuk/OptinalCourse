	...
	<body>
		...
		<!-- -->
                ...
                <c:choose>
                        ...
                        <table  class="table table-striped">
                            ...
                            <c:forEach var="course" items="${userCourses}">
                                ...
                                <tr class="${classSucess}">
                                    ...
                                    <td><a href="#" id="delete" 
                                           onclick="document.getElementById('command').value ='delete_user_course';
                    ...
                    <c:otherwise>
                        ...
                        <div class="alert alert-info">
                            No userCourses found matching your search criteria
                        </div>
                    </c:otherwise>
                </c:choose>                        
            </form>
            ...
            <form action ="controller" method="get">
            	...
            	<input type="hidden" id="command" name="command" value="prepare_course_reg_form">            
                <br></br>
